...
task :install do
  ...
  install_vundle
  replace_all = false
  files = Dir['*'] - %w[Rakefile README.md LICENSE.md oh-my-zsh atom]
  files += Dir['atom/*']
...
def install_homebrew_packages
  ...
  when 'y'
    ...
    system %Q{brew install autojump git leiningen mysql node tig tree tmux imagemagick git-extras the_silver_searcher terminal-notifier graphicsmagick}
